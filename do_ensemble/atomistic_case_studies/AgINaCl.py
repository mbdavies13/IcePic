...
sysname = 'AgINaCl'
list_zpredFILE = ['Ag001_293K_wat_zpred.txt', 'I001_293K_wat_zpred.txt']
...
for STRAT_N in [1, 2, 3, 4, 5, 6]:
    ...
    ###### GET AgINaCl image
    X_test = []
    for zpredFILE in list_zpredFILE:
        path = '../../../atomistic_INPs/AgINaCl_TIP4P2005/{0}'.format(zpredFILE)
